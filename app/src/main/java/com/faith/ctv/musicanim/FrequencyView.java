...
public class FrequencyView extends View implements View.OnClickListener{
    ...
    private static final int SHORT_LINE_HEIGHT = 40; // 最短的线的高度
    private static final int mLintToLineW = 20; // 线和线之间的距离值
    private static final int FRAME_NUM = 8; // 每帧增加的高度
    ...
    private void init(){
        ...
        mPaint.setStrokeWidth(dp2px(getContext(),2f)); // 画笔的粗细
    ...
    private void initData(){
        post(new Runnable() {
            ...
            public void run() {
                ...
                mEndY = mStartY + SHORT_LINE_HEIGHT;
                for (int i = 0; i < LINE_ANIM_COUNT; i++) { // 绘制首次的频率画面
                    float startY = mEndY - SHORT_LINE_HEIGHT * (i + 1) * 1 / 2;
                ...
                line1.startYs = new float[]{line1.startY + FRAME_NUM * 2, line1.startY+ FRAME_NUM, line1.startY }; // 由小到大
                ...
                line2.startYs = new float[]{line2.startY - FRAME_NUM * 2, line2.startY - FRAME_NUM, line2.startY}; // 由大到小
                ...
                line3.startYs = new float[]{line3.startY + FRAME_NUM + FRAME_NUM * 1 / 2, line3.startY + FRAME_NUM + FRAME_NUM * 1 / 4, line3.startY}; // 由小到大
                ...
                line4.startYs = new float[]{line4.startY - FRAME_NUM * 2, line4.startY - FRAME_NUM,  line4.startY}; // 由大到小
